...
| `FlagDecreeIds` | Shared Earth→Luna→Mars decree string ids mapped to `FlagType` — [flag-type map](FLAG_TYPE_MAP_EARTH_LUNA_MARS.md), [W2 advisor copy](W2_ADVISOR_AND_CHAIN_BEATS.md) |
