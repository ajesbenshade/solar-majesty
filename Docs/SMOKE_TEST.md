...
- [ ] Colony Commons: **geodesic / polyhedron command dome** (frequency-3 inset lattice, orange equator / cupola bands) on a dark mechanical ring — not a smooth sphere, not a grey box. Same 6×6 footprint. HUD **COMMONS**. CaptureStill pad / solar / extractors sit ~4 cells of empty dirt off Commons.
