...
- Colony Commons as the large central **command-dome citadel** (player-facing **COMMONS**, not Palace / not mockup “Command Center” label) with a frequency-3 geodesic facet lattice, orange equatorial / cupola bands, and drum meridians. CaptureStill landmark yards keep 4 empty cells off the dome.
