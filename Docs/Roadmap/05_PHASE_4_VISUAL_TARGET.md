...
- Colony Commons as the large central **command-dome citadel** (player-facing **COMMONS**, not Palace / not mockup “Command Center” label) with a frequency-4 cream geodesic facet lattice, proud dark triangular ribs, orange equatorial / cupola bands, and drum meridians. CaptureStill landmark yards keep 4 empty cells off the dome.
