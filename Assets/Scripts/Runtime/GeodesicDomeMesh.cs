...
{
    /// <summary>
    /// Flat-shaded geodesic shell: subdivided icosahedron projected onto an ellipsoid.
    /// Each facet is its own three verts so the triangle grid stays hard-edged at play
    /// ortho. Optional inset shrinks cream plates toward the centroid so a darker
    /// geodesic undershell reads as the lattice. Coplanar triangles only — not square
    /// hull panels and not a box-rib overlay.
    /// </summary>
