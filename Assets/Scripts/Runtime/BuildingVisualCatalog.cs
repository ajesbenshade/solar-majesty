    ...
    public static class BuildingVisualCatalog
    {
        private static readonly Dictionary<BuildingCategory, string> CategoryResource =
            new Dictionary<BuildingCategory, string>
            {
                ...
                { BuildingCategory.Market, "Buildings/SM_CMD1_CommandBuilding" },
                { BuildingCategory.Blacksmith, "Buildings/SM_OPS1_OperationsUnit" },
                { BuildingCategory.FobotYard, "Buildings/SM_CMD1_CommandBuilding" },
                { BuildingCategory.Watchtower, "Buildings/SM_CMD1_CommandBuilding" },
                { BuildingCategory.AidStation, "Buildings/SM_LAB1_LaboratoryModule" },
        ...
        private static readonly Dictionary<BuildingCategory, string> HeroResource =
            new Dictionary<BuildingCategory, string>
            {
                ...
                { BuildingCategory.Market, "Buildings/SM_Hero_Inn" },
                { BuildingCategory.Blacksmith, "Buildings/SM_Hero_OPS" },
                { BuildingCategory.FobotYard, "Buildings/SM_Hero_Workshop" },
                { BuildingCategory.Watchtower, "Buildings/SM_Hero_Defense" },
                { BuildingCategory.AidStation, "Buildings/SM_Hero_LAB" },
